...
#######################################################################
{"success":false}
func_1()::func_2 qw(looks_like_number)
...
#######################################################################
{"success":false}
func_1()::func_5::func_4::func_3->func_2
...
#######################################################################
{"success":false}
return func_1()::func_3->func_2($x_1->{b})
...
#######################################################################
{"success":false}
func_1()::func_5::func_4::func_3->func_2($x_1)
...
#######################################################################
{"success":true}
return { 'c'=> (@{$x_1->{b}} ? func_1() : func_2()), 'c'=> $x_1->{b}, }
(return ({'c', (@{$x_1->{'b'};} ? func_1() : func_2()), 'c', $x_1->{'b'}}));
return({ 'c',(@{$x_1->{'b'}}?func_1():func_2()),'c',$x_1->{'b'}})
#######################################################################
{"success":true}
...
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> "$x_i", 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, )
$x_1->func_1('c', $x_2, 'c', "$x_i", 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6);
$x_1->func_1( 'c',$x_2,'c',"$x_i",'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6)
#######################################################################
{"success":false}
...
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> "$x_i", 'c'=> $x_3->{b}, 'c'=> "$x_i", 'c'=> $x_4, 'c'=> 0, )
$x_1->func_1('c', $x_2, 'c', "$x_i", 'c', $x_3->{'b'}, 'c', "$x_i", 'c', $x_4, 'c', 0);
$x_1->func_1( 'c',$x_2,'c',"$x_i",'c',$x_3->{'b'},'c',"$x_i",'c',$x_4,'c',0)
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> 'c', 'c'=> 'c', 'c'=> $x_1->func_2, 'c'=> 'c', 'c'=> $x_2, 'c'=> $x_1->{b}, )
$x_1->func_1('c', 'c', 'c', 'c', 'c', $x_1->func_2, 'c', 'c', 'c', $x_2, 'c', $x_1->{'b'});
$x_1->func_1( 'c','c','c','c','c',$x_1->func_2,'c','c','c',$x_2,'c',$x_1->{'b'})
#######################################################################
{"success":true}
...
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> "$x_i", 'c'=> "$x_i", 'c'=> $x_3, 'c'=> "$x_i", 'c'=> $x_4, 'c'=> $x_5, )
$x_1->func_1('c', $x_2, 'c', "$x_i", 'c', "$x_i", 'c', $x_3, 'c', "$x_i", 'c', $x_4, 'c', $x_5);
$x_1->func_1( 'c',$x_2,'c',"$x_i",'c',"$x_i",'c',$x_3,'c',"$x_i",'c',$x_4,'c',$x_5)
#######################################################################
{"success":true}
...
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> "$x_i", 'c'=> "$x_i", 'c'=> $x_3->[$x_2], 'c'=> "$x_i", 'c'=> $x_4, 'c'=> $x_5, )
$x_1->func_1('c', $x_2, 'c', "$x_i", 'c', "$x_i", 'c', $x_3->[$x_2], 'c', "$x_i", 'c', $x_4, 'c', $x_5);
$x_1->func_1( 'c',$x_2,'c',"$x_i",'c',"$x_i",'c',$x_3->[$x_2],'c',"$x_i",'c',$x_4,'c',$x_5)
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> "$x_i", 'c'=> $x_6, 'c'=> "$x_i", 'c'=> $x_7, 'c'=> 0, )
$x_1->func_1('c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', "$x_i", 'c', $x_6, 'c', "$x_i", 'c', $x_7, 'c', 0);
$x_1->func_1( 'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',"$x_i",'c',$x_6,'c',"$x_i",'c',$x_7,'c',0)
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> "$x_i", 'c'=> $x_6, 'c'=> "$x_i", 'c'=> $x_7, 'c'=> $x_8, )
$x_1->func_1('c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', "$x_i", 'c', $x_6, 'c', "$x_i", 'c', $x_7, 'c', $x_8);
$x_1->func_1( 'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',"$x_i",'c',$x_6,'c',"$x_i",'c',$x_7,'c',$x_8)
#######################################################################
{"success":true}
...
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, 'c'=> $x_11, )
$x_1->func_1('c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10, 'c', $x_11);
$x_1->func_1( 'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10,'c',$x_11)
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> $x_2, 'c'=> "$x_i", 'c'=> $x_3, 'c'=> "$x_i", 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, )
$x_1->func_1('c', $x_2, 'c', $x_2, 'c', "$x_i", 'c', $x_3, 'c', "$x_i", 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8);
$x_1->func_1( 'c',$x_2,'c',$x_2,'c',"$x_i",'c',$x_3,'c',"$x_i",'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8)
#######################################################################
{"success":true}
$x_1 = $x_3->$x_2( 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, 'c'=> $x_11, 'c'=> $x_12, 'c'=> $x_13, )
($x_1 = $x_3->$x_2('c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10, 'c', $x_11, 'c', $x_12, 'c', $x_13));
($x_1 = $x_3->$x_2( 'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10,'c',$x_11,'c',$x_12,'c',$x_13))
#######################################################################
{"success":true}
$x_1->func_1( 'c'=> $x_2, 'c'=> $x_2, 'c'=> "$x_i", 'c'=> $x_3, 'c'=> "$x_i", 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7->{$x_2}, 'c'=> $x_8, )
$x_1->func_1('c', $x_2, 'c', $x_2, 'c', "$x_i", 'c', $x_3, 'c', "$x_i", 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7->{$x_2}, 'c', $x_8);
$x_1->func_1( 'c',$x_2,'c',$x_2,'c',"$x_i",'c',$x_3,'c',"$x_i",'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7->{$x_2},'c',$x_8)
#######################################################################
{"success":true}
$x_1->func_1->( 'c'=> func_2(), 'c'=> "$x_i", 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, )
$x_1->func_1->('c', func_2(), 'c', "$x_i", 'c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10);
$x_1->func_1->( 'c',func_2(),'c',"$x_i",'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10)
#######################################################################
{"success":true}
$x_1->func_1->( 'c'=> func_2(), 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, 'c'=> $x_11, ) 
$x_1->func_1->('c', func_2(), 'c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10, 'c', $x_11);
$x_1->func_1->( 'c',func_2(),'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10,'c',$x_11)
#######################################################################
{"success":true}
...
#######################################################################
{"success":true}
$x_1->func_1->( 'c'=> func_2(), 'c'=> "$x_i", 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> "$x_i", 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, ) 
$x_1->func_1->('c', func_2(), 'c', "$x_i", 'c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', "$x_i", 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9);
$x_1->func_1->( 'c',func_2(),'c',"$x_i",'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',"$x_i",'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9)
#######################################################################
{"success":true}
$x_1->func_1->( 'c'=> func_2(), 'c'=> "$x_i", 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> scalar $x_9, 'c'=> $x_10, ) 
$x_1->func_1->('c', func_2(), 'c', "$x_i", 'c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', scalar($x_9), 'c', $x_10);
$x_1->func_1->( 'c',func_2(),'c',"$x_i",'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',scalar($x_9),'c',$x_10)
#######################################################################
{"success":true}
return [ $x_1->func_1->( 'c'=> func_2(), 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, 'c'=> $x_11, ) ]
(return ([$x_1->func_1->('c', func_2(), 'c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10, 'c', $x_11)]));
return([ $x_1->func_1->( 'c',func_2(),'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10,'c',$x_11)])
#######################################################################
{"success":true}
...
#######################################################################
{"success":true}
return [ $x_1->func_1->( 'c'=> func_2(), 'c'=> "$x_i", 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, ) ] 
(return ([$x_1->func_1->('c', func_2(), 'c', "$x_i", 'c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10)]));
return([ $x_1->func_1->( 'c',func_2(),'c',"$x_i",'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10)])
#######################################################################
{"success":true}
push @$x_1, $x_2->func_1->( 'c'=> func_2(), 'c'=> "$x_i", 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, 'c'=> $x_11, )
push(@$x_1, $x_2->func_1->('c', func_2(), 'c', "$x_i", 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10, 'c', $x_11));
push(@$x_1,$x_2->func_1->( 'c',func_2(),'c',"$x_i",'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10,'c',$x_11))
#######################################################################
{"success":true}
...
#######################################################################
{"success":true}
push @$x_1, $x_2->func_1->( 'c'=> func_2(), 'c'=> "$x_i", 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> "$x_i", 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, ) 
push(@$x_1, $x_2->func_1->('c', func_2(), 'c', "$x_i", 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', "$x_i", 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10));
push(@$x_1,$x_2->func_1->( 'c',func_2(),'c',"$x_i",'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',"$x_i",'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10))
#######################################################################
{"success":true}
return [ $x_1->func_1->( 'c'=> func_2(), 'c'=> "$x_i", 'c'=> $x_2, 'c'=> $x_3, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> scalar $x_9, 'c'=> $x_10, ) ] 
(return ([$x_1->func_1->('c', func_2(), 'c', "$x_i", 'c', $x_2, 'c', $x_3, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', scalar($x_9), 'c', $x_10)]));
return([ $x_1->func_1->( 'c',func_2(),'c',"$x_i",'c',$x_2,'c',$x_3,'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',scalar($x_9),'c',$x_10)])
#######################################################################
{"success":true}
$x_1 = $x_2->func_1( 'c'=> $x_2->{b}{$x_3}, 'c'=> $x_4, 'c'=> $x_5, 'c'=> $x_6, 'c'=> $x_7, 'c'=> $x_8, 'c'=> $x_9, 'c'=> $x_10, 'c'=> $x_11, 'c'=> $x_12, 'c'=> $x_3, 'c'=> $x_13, )
($x_1 = $x_2->func_1('c', $x_2->{'b'}{$x_3}, 'c', $x_4, 'c', $x_5, 'c', $x_6, 'c', $x_7, 'c', $x_8, 'c', $x_9, 'c', $x_10, 'c', $x_11, 'c', $x_12, 'c', $x_3, 'c', $x_13));
($x_1 = $x_2->func_1( 'c',$x_2->{'b'}{$x_3},'c',$x_4,'c',$x_5,'c',$x_6,'c',$x_7,'c',$x_8,'c',$x_9,'c',$x_10,'c',$x_11,'c',$x_12,'c',$x_3,'c',$x_13))
#######################################################################