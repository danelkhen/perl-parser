...
'func_5::func_4::func_3::func_2'->func_1
'Bookings::JSON::Schema::Null'->func_1
#######################################################################
{"success":false}
...
sort {($x_1 cmp $x_2);} CORE::keys(%{$x_3;})
sort({ ($x_1 cmp $x_2)}keys(%({ $x_3})))
#######################################################################
{"success":false}
...
(return CORE::bless({'func_1', 'b', $x_1}, $x_2))
(return bless({ func_1,b=>$x_1},$x_2))
#######################################################################
{"success":false}
...
'func_5::func_4::func_3::func_2'->func_1($x_1)
'Bookings::JSON::Schema::Error'->func_1($x_1)
#######################################################################
{"success":false}
...
sort {(lc($x_1) cmp lc($x_2));} CORE::keys(%{$x_3;})
sort({ (lc($x_1) cmp lc($x_2))}keys(%({ $x_3})))
#######################################################################
{"success":false}
"$x_i". (join "$x_i", @{ $x_1->{'c'} }) . 'c'
(("$x_i" . CORE::join("$x_i", @{$x_1->{'c'};})) . 'c')
(("$x_i" . (join("$x_i",@({ $x_1->{'c'}})))) . 'c')
#######################################################################
{"success":false}
...
(scalar(CORE::keys(%{$x_1;})) != scalar(CORE::keys(%{$x_2;})))
(scalar(keys((%({ $x_1}) != scalar(keys(%({ $x_2})))))))
#######################################################################
{"success":false}
$x_1 = [ sort { $x_2 cmp $x_3 } keys %{ $x_4 } ]
($x_1 = [(sort {($x_2 cmp $x_3);} CORE::keys(%{$x_4;}))])
($x_1 = [ sort({ ($x_2 cmp $x_3)}keys(%({ $x_4})))])
#######################################################################
{"success":true}
...
($x_1 = [(sort {(lc($x_2) cmp lc($x_3));} CORE::keys(%{$x_4;}))])
($x_1 = [ sort({ (lc($x_2) cmp lc($x_3))}keys(%({ $x_4})))])
#######################################################################
{"success":false}
$x_1->("$x_i". (join "$x_i", @{ $x_2->{'c'} }) . 'c') 
&$x_1((("$x_i" . CORE::join("$x_i", @{$x_2->{'c'};})) . 'c'))
$x_1->((("$x_i" . (join("$x_i",@({ $x_2->{'c'}})))) . 'c'))
#######################################################################
{"success":false}
...
CORE::push($x_1, $x_2->func_1($x_3, $x_3->{'c'}, $x_4, $x_5, $x_6))
push($x_1,$x_2->func_1($x_3,$x_3->{'c'},$x_4,$x_5,$x_6))
#######################################################################
{"success":false}
...
CORE::push(@{$$x_1{'b'};}, $x_1->func_1($x_2, $x_3, $x_4, $x_5, $x_6))
push(@({$x_1->{'b'}}),$x_1->func_1($x_2,$x_3,$x_4,$x_5,$x_6))
#######################################################################
{"success":false}
...
CORE::push(@{$$x_1{'b'};}, $x_1->func_1($x_2->{'c'}, $x_3, $x_4, $x_5, $x_2))
push(@({$x_1->{'b'}}),$x_1->func_1($x_2->{'c'},$x_3,$x_4,$x_5,$x_2))
#######################################################################
{"success":false}
...
CORE::push(@{$$x_1{'b'};}, $x_1->func_1($x_2, $x_3->[$x_4], $x_5, $x_4, $x_6))
push(@({$x_1->{'b'}}),$x_1->func_1($x_2,$x_3->[$x_4],$x_5,$x_4,$x_6))
#######################################################################
{"success":false}
...
CORE::push(@{$$x_1{'b'};}, $x_1->func_1($x_2, $x_3, $x_4->{'c'}, $x_4->{'c'}, $x_4->{'c'}, $x_5))
push(@({$x_1->{'b'}}),$x_1->func_1($x_2,$x_3,$x_4->{'c'},$x_4->{'c'},$x_4->{'c'},$x_5))
#######################################################################
{"success":false}
...
CORE::push(@$x_1, $x_2->func_1->('b', 'func_2', 'b', "$x_i", 'b', $x_3, 'b', $x_4, 'b', $x_5, 'b', $x_6, 'b', $x_7, 'b', $x_8, 'b', $x_9, 'b', $x_10, 'b', $x_11))
push(@($x_1),$x_2->func_1->( b=>func_2,b=>"$x_i",b=>$x_3,b=>$x_4,b=>$x_5,b=>$x_6,b=>$x_7,b=>$x_8,b=>$x_9,b=>$x_10,b=>$x_11,))
#######################################################################
{"success":false}
return [ $x_1->func_1->(  b=> func_2, b=> "$x_i", b=> $x_2, b=> $x_3, b=> $x_4, b=> $x_5, b=> $x_6, b=> $x_7, b=> $x_8, b=> $x_9, b=> $x_10, ) ] 
...
CORE::push(@$x_1, $x_2->func_1->('b', 'func_2', 'b', "$x_i", 'b', $x_3, 'b', $x_4, 'b', $x_5, 'b', $x_6, 'b', "$x_i", 'b', $x_7, 'b', $x_8, 'b', $x_9, 'b', $x_10))
push(@($x_1),$x_2->func_1->( b=>func_2,b=>"$x_i",b=>$x_3,b=>$x_4,b=>$x_5,b=>$x_6,b=>"$x_i",b=>$x_7,b=>$x_8,b=>$x_9,b=>$x_10,))
#######################################################################
{"success":false}
