...
declare module "ace/background_tokenizer" {
    ...
    **/
    ...
    export var BackgroundTokenizer: {
        /**
...
declare module "ace/edit_session" {
    import {Mode as TextMode} from "ace/mode/text";
    import {Editor} from "ace/editor";
    import {BackgroundTokenizer} from "ace/background_tokenizer";
    import {TokenInfo} from "ace/token_info";
...
declare module "ace/editor_command" {
...
declare module "ace/command_manager" {
    import {Editor} from "ace/editor";
...
declare module "ace/editor" {
    import {CommandManager} from "ace/command_manager";
...
declare module "ace/render_loop" {
    ...
    export var RenderLoop: {
        new (): RenderLoop;
    }

}
declare module "ace/scroll_bar" {
    ////////////////
    /// ScrollBar
    ////////////////
...
declare module "ace/undo_manager" {
    //////////////////
    /// UndoManager
    //////////////////
