...
sub listop {
    ...
    if ($parens && $nollafr) {
	#DK - causes inconsistent paren - return $a vs. return ($a+$b)
...
sub pp_entersub {
	...
	if ($op->flags & OPf_STACKED) {
        #print "STACKED: ".$prefix . $amper . $kid . "(" . $args . ")"."\n";
